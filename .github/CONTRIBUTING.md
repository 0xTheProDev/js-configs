...
See the [README](https://github.com/0xTheProDev/js-configs#readme) to get an overview of the project. Here are some helpful resources to get you comfortable with open source contribution:
...
- Take a look at the Existing Issues or visit [Discussions Section](https://github.com/0xTheProDev/js-configs/discussions) to engage into discussion about feature request or bug reporting.
...
```bash
$ git clone https://github.com/<your-username>/js-configs
$ cd js-configs
$ git remote add upstream https://github.com/0xTheProDev/js-configs
$ git fetch upstream
```
